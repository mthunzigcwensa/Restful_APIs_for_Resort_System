...
namespace RestfulAPIs.Repositories
{
    public class UserRepository : IUserRepository
    {
        ...
        public UserRepository(DataBaseContext db, IConfiguration configuration,
        ...
        private async Task<string> GetAccessToken(ApplicationUser user, string jwtTokenId)
        {
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                Subject = new ClaimsIdentity(new Claim[]
                {
                    ...
                    new Claim(JwtRegisteredClaimNames.Aud, "mthunzi.com")
                }),
                Expires = DateTime.UtcNow.AddMinutes(2),
                Issuer = "https://resort-api.com",
                Audience = "https://test-resort-api.com",
